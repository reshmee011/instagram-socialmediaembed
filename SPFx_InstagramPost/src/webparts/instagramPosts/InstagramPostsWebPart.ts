...
import { IInstagramPostsProps, IInstagramPostsWebPartProps } from '../../models';
          ...
          groups: [
            {
              ...
              groupFields: [
                PropertyPaneTextField('postsLimit', {
                  label: strings.NumberOfPostsToDisplayPerViewFieldLabel
                })
              ]
            }
          ]
